 ...
 * @subpackage Patterns_Woocommerce/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Woocommerce_Api' ) ) {

	/**
	 * Patterns_Woocommerce_Api
	 *
	 * @package Patterns_Woocommerce
	 * @since 1.0.1
	 */
	class Patterns_Woocommerce_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-woocommerce' ), '1.0.0' );
		}
